...
$w.onReady(function () {
    // --- Task 1: Generate a new unique Operation ID ---
...
/**
 * Generates a unique, human-readable ID and places it in the operationIdInput field.
...
function setupSaveAndNavigate() {
    $w('#saveButton').onClick(async () => {
        ...
        try {
            ...
            // The 'savedItem' object contains all the new operation's data,
            ...
            // Replace 'name' if your dynamic page URL uses a different field (like the Operation ID).
            const dynamicPageUrl = savedItem['link-operations-operationId']; 
            ...
            if (dynamicPageUrl) {
                ...
                console.error("Could not find the dynamic page URL for the new operation.");
